...
tr_filedir = './data sets/EOC-1/train/';
tt_filedir = './data sets/EOC-1/test/';
...
num_views = 52;
tr_data_EOC_1 = load('./data sets/EOC-1/tr_data_EOC_1.mat');
tt_data_EOC_1 = load('./data sets/EOC-1/tt_data_EOC_1.mat');
tr_dat_view = tr_data_EOC_1.tr_data_EOC_1;
tt_dat_view = tt_data_EOC_1.tt_data_EOC_1;
for i = 1:num_views
...
beta_group_EOC_1 = load('beta_group_EOC_1.mat');
beta_group = beta_group_EOC_1.beta_group_EOC_1.beta_group; % load the trained weights
% for p = 1:num_kernels
...
%     end
% end
% save('YTY_kernel_EOC_1.mat','YTY_kernel');
YTY_kernel_EOC_1 = load('./data sets/EOC-1/YTY_kernel_EOC_1.mat');
YTY_kernel = YTY_kernel_EOC_1.YTY_kernel;
