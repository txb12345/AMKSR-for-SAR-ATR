...
tr_filedir = './data sets/EOC-2/train17/';
tt_filedir = './data sets/EOC-2/test15/';
...
num_views = 42;
tr_data_EOC_2 = load('./data sets/EOC-2/tr_data_EOC_2.mat');
tt_data_EOC_2 = load('./data sets/EOC-2/tt_data_EOC_2.mat');
tr_dat_view = tr_data_EOC_2.tr_data_EOC_2;
tt_dat_view = tt_data_EOC_2.tt_data_EOC_2;
for i = 1:num_views
    tr_dat_view{i} = zscore((tr_dat_view{i}(:,1:8))');
    tt_dat_view{i} = zscore((tt_dat_view{i}(:,1:8))');
end
...
beta_group_EOC_2 = load('beta_group_EOC_2.mat');
beta_group = beta_group_EOC_2.beta_group;  % load the trained weights
% for p = 1:num_kernels
...
%     end
% end
% save('YTY_kernel_EOC_2.mat','YTY_kernel');
YTY_kernel_EOC_2 = load('./data sets/EOC-2/YTY_kernel_EOC_2.mat');
YTY_kernel = YTY_kernel_EOC_2.YTY_kernel;
