...
num_views = 42;
tr_data_EOC_3 = load('./data sets/EOC-3/tr_data_EOC_3.mat');
tt_data_EOC_3 = load('./data sets/EOC-3/tt_data_EOC_3.mat');
tr_dat_view = tr_data_EOC_3.tr_data_EOC_3;
tt_dat_view = tt_data_EOC_3.tt_data_EOC_3;
for i = 1:num_views
...
num_kernels = 20;
sparsity = 12;
beta_group_EOC_3 = load('beta_group_EOC_3.mat');
beta_group = beta_group_EOC_3.beta_group_EOC_3.beta_group;
% for p = 1:num_kernels
...
%     end
% end
% save('YTY_kernel_EOC_3.mat','YTY_kernel');
YTY_kernel_EOC_3 = load('./data sets/EOC-3/YTY_kernel_EOC_3.mat');
YTY_kernel = YTY_kernel_EOC_3.YTY_kernel;
